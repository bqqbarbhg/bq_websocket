...
clang -g -std=gnu99 -Wno-unused-value -lpthread -D_GNU_SOURCE ../bq_websocket.c ../bq_websocket_platform.c ../test/fuzz/fuzz_protocol.c ../examples/echo_client_pt.c -o example_echo_client_pt
